...
namespace KPI.Web.Areas.SystemManage.Controllers
{
    public class RoleAuthorizeController : ControllerBase
    {
        ...
        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetMenuList(string roleId)
        {
            return Content(roleAuthorizeApp.GetMenuList(roleId).ToJson());
        }
        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetButtonList(string roleId)
        {
            return Content(roleAuthorizeApp.GetButtonList(roleId).ToJson());
        }
    }
}
