    ...
    methods: {
        ...
        getData(){
            ...
            this.timeOut = setTimeout(() => {
                this.$http.get('/BranchAssessment/GetBranchAssessmentDetail',{params:params}).then((result) => {
        ...
        toJudgeManageFilialeCheck(item) {
            ...
            this.$router.push({name:name,params:{assessment_id:item.assessment_id,check_object:item.branch_id,assessment_detail_statue:item.flag,type:this.type,filing_people:this.$route.params.filing_people}})
        ...
        ReAssessment() {
            ...
            this.$http.post('/BranchAssessment/ReLaunchBranchAssessment',params).then((result) => {
                if(result.state == 1) {
                    this.$message({
                        type: 'success',
